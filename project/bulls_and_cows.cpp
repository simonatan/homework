...
int main()
{
    ...
    while(game)
    {
        ...
        if(digit==4)
        {
            ...
            while(DifferentDigits(secretnum4)) secretnum4=rand()%9000+1000;
        ...
        else if(digit==3)
        {
            ...
            while(DifferentDigits(secretnum3)) secretnum3=rand()%900+100;
        ...
        else
        {
            ...
            while(DifferentDigits(secretnum2)) secretnum2=rand()%90+10;
